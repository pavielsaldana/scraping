            ...
            try:
                ...
                if dataframe_input is not None and not dataframe_input.empty:
                    if owler_revenue_option == "Search Owler URLs & Scraping Owler URLs":
                        ...
                        dataframe_results = scraping_owler_urls(dataframe_search_results, domainColumnName, zenrowsApiKey, owlerColumnName, spreadsheet_url, sheet_name_result, key_dict)
